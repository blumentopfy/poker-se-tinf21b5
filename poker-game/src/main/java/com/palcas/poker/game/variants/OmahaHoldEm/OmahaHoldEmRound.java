...
public class OmahaHoldEmRound extends Round {
    ...
    @Override
    protected LinkedHashMap<Player, OmahaHoldEmPocket> distributePocketCards() {
        LinkedHashMap<Player, OmahaHoldEmPocket> playersWithPockets = new LinkedHashMap<>();
        for (Player player : this.gameState.getPlayers()) {
            OmahaHoldEmPocket newPocket = new OmahaHoldEmPocket().populatePocket(this.gameState.getDeck());
