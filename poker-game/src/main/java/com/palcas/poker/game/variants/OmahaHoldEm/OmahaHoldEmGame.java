...
public class OmahaHoldEmGame extends PokerGame {
    ...
    public OmahaHoldEmGame(Player mainPlayer, ArrayList<Player> players) {
        this.gameState = new GameState(mainPlayer, players);
        this.mainPlayer = mainPlayer;
        this.initialMainPlayerChips = mainPlayer.getChips();
        this.scanner = new Scanner(System.in);
        this.botActionService = new EmpiricalBotActionService(1000);
    ...
    public GameResult playGame() {
        ...
        System.out.println("Starting a game of Omaha Hold'em...");
    ...
    protected void startPokerGameLoop() {
        ...
        while (gameRunning) {
            ...
            gameState = new OmahaHoldEmRound(gameState, botActionService).executeRound();
            roundsPlayed++;
